 ...
 for(int i=0; i < 10; i++){
    for(int j=0; j < 10; j++){
          ...
          if(j < 5){
            ...
            if(j+1 < 5 && (battleArena[i][j+1] == 'o' || battleArena[i][j+1] == 'm')){
            ...
            if(i+1 < 5 && (battleArena[i+1][j] == 'o' || battleArena[i+1][j] == 'm')){
            ...
            if(j-1 > 4 && (battleArena[i][j-1] == 'h' || battleArena[i][j-1] == 'm')){
                
                counterHM++;
            }

            if(j+1 < 10 && (battleArena[i][j+1] == 'h' || battleArena[i][j+1] == 'm')){
                
                counterHM++;
            }

            if(i-1 > 4 && (battleArena[i-1][j] == 'h' || battleArena[i-1][j] == 'm')){
                
                counterHM++;
            }

            if(i+1 < 10 && (battleArena[i+1][j] == 'h' || battleArena[i+1][j] == 'm')){
